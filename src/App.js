    ...
    return (
      <div className="App">
        ...
        <div className="App-pictures">
          <img alt="comic panel" src={'http://i.imgur.com/Ohuu7bI.jpg?1'} />
          <img alt="comic panel" src={'http://i.imgur.com/dZoFSAo.jpg?1'} />
          <img alt="comic panel" src={'http://i.imgur.com/tEQAwsG.jpg?1'} />
        </div>
      </div>
    );
  }
